...
cmake -G "Visual Studio 9 2008" -DCMAKE_INSTALL_PREFIX="%~3" -DGSL_INCLUDE_DIR="C:\Program Files\GnuWin32\include" -DGSL_LIB_DIR="C:\Program Files\GnuWin32\lib" %cmake_configs% -DPYTHON_SITE_PACKAGES_DIR="%~3\python" "%~2"
